...
public class FinalSales {
    ...
    public FinalSales(FileInputStream file1, String ctgName){
        this.filePath=file1;
    ...
    public double calculateTotalSales(){
        ...
        while(qtyList.size()>val){
            ctgSales += (qtyList.get(val)*priceList.get(val))+shipAmtList.get(val);
            val++;
        }
        return ctgSales;
    }
